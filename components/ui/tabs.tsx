  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:[background:var(--bg-button)] dark:data-[state=active]:text-foreground data-[state=active]:text-foreground",
